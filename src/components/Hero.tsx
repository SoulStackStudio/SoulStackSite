  ...
  return (
    <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 py-24 text-center text-white">
        ...
        <Link
          href="/shop"
          className="mt-10 inline-block rounded-full bg-white/95 px-8 py-3 text-sm font-medium tracking-widest uppercase text-brand-deep shadow-lg transition hover:bg-aqua hover:text-white"
        >
          ...
          {imagePanel ? (
            <div className="w-80 rounded-xl bg-white p-4 shadow-2xl">
              ...
              <button
                ...
                className="mt-3 w-full rounded-lg bg-brand py-2 text-sm font-medium text-white hover:bg-brand-deep"
              >
                Save image
              </button>
            </div>
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-full bg-white/90 px-4 py-2 text-sm font-medium text-brand shadow-lg transition hover:bg-white"
            >
